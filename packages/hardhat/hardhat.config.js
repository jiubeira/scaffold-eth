...
module.exports = {
  ...
  networks: {
    ...
    kovan: {
      url: "https://kovan.infura.io/v3/c374922eb47a40bfaadaff5eeb1dad7a", // <---- YOUR INFURA ID! (or it won't work)
      //    url: "https://speedy-nodes-nyc.moralis.io/XXXXXXXXXXXXXXXXXXXXXXX/eth/kovan", // <---- YOUR MORALIS ID! (not limited to infura)
      accounts: process.env.KOVAN_DEPLOYER_PRIV_KEY !== undefined ? [process.env.KOVAN_DEPLOYER_PRIV_KEY] : [],
    },
    mainnet: {
